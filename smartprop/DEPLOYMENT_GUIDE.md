...
# Stop
ssh -i /Users/vincent/propertydemo/smartprop-new-key.pem -o StrictHostKeyChecking=no ${EC2_USER:-ec2-user}@${EC2_IP} 'pm2 stop smartprop'
```
...
PUBLIC_BASE_URL=http://<NEW_VPS_HOST>:3000
# ... other variables
```
...
- **Application**: http://<NEW_VPS_HOST>:3000
- **Admin Dashboard**: http://<NEW_VPS_HOST>:3000/admin
- **Health Check**: http://<NEW_VPS_HOST>:3000/api/health
