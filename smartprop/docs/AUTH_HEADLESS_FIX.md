...
2. **SSH test**: `ssh -i /Users/vincent/propertydemo/smartprop-new-key.pem -o StrictHostKeyChecking=no ${EC2_USER:-ec2-user}@${EC2_IP} "cd /opt/smartprop/app/smartprop && xvfb-run -a bun src/workers/auth.pg.ts"` - should work
