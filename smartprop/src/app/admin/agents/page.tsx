...
export default function AgentsPage() {
  ...
  }, [page, searchTerm, letterFilter, sourceFilter, sortOrder, retryToken]);
  ...
  return <div className="space-y-6">
    ...
    <Card><CardHeader><div className="flex flex-wrap items-center justify-between gap-3"><div><CardTitle>Agent Directory</CardTitle><CardDescription>{isLoading ? 'Loading...' : loadError ? 'Agents unavailable' : `Showing ${showing.start}-${showing.end} of ${total} agents`}</CardDescription></div><Button onClick={exportToCSV} variant="outline" className="flex items-center gap-2"><Download className="h-4 w-4" /> Export page</Button></div></CardHeader>
